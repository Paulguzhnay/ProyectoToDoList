"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\Diego\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.343\\out\\buildHook\\index.js').default({tool: 'angular', checkSum: '20fe9181bd1abf81255a04V10XABYFWAYABFNVWwECVgZQUVJR'}); } catch(cjsError) { try { import('file:///c:/Users/Diego/.vscode/extensions/wallabyjs.console-ninja-1.0.343/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20fe9181bd1abf81255a04V10XABYFWAYABFNVWwECVgZQUVJR'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
